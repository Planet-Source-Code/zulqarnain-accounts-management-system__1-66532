...
Begin VB.UserControl ucProgressBar 
   ...
   ScaleHeight     =   990
   ScaleWidth      =   3000
   ToolboxBitmap   =   "CtlUltraPGBar.ctx":0000
End
...
'****THIS CONTROL IS NOT BY ME*****'
'THANKS TO DEAN CAMMERON'
...
Private m_DoubleValOnMetal As Boolean
...
Public Property Let DoubleValOnMetal(ByVal NewValue As Boolean)
    m_DoubleValOnMetal = NewValue
    DrawProgressBar
End Property

Public Property Get DoubleValOnMetal() As Boolean
    DoubleValOnMetal = m_DoubleValOnMetal
End Property
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_DoubleValOnMetal = PropBag.ReadProperty("DoubleValOnMetal", 0)
End Sub
